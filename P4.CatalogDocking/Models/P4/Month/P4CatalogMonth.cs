...
{
    public class P4CatalogMonth : BaseModel
    {
        public string OkatoFact { get; set; }
        public string OkvedFact { get; set; }
        public string TypActual { get; set; }

        public P4CatalogMonth(string okpo, string okpoUl, string name, string okatoFact, string okvedFact, string typPred, string okfs, string okogu, string typActual, string okopf) 
